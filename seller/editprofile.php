<?php
$title = "Profile Edite || Azad Demo Shop";
$asset = "";
$adloc = "../";
$autoloc = "../";
$fnloc = "../";
        ...
        <div id="maindiv" class="col-lg-9">  
            <div class="content">
                <form action="" method="post" enctype="multipart/form-data">
                    <h5 class="heading mb-2">Profile Information</h5>
                    <?php
                        if(isset($usr->suc)){
                            ?>
                    ...
                    <div class="editsection pr-3">
                        <div class="row">
                            <div class="col-3">
                                ...
                                <div class="profile_image">
                                    <input type="file" id="bgimage" name="bgimage" data-height="100" class="dropify" data-default-file="<?= $dir.$usrdata['background'] ?>" >
                                    <input type="hidden" name="oldbg" value="<?= $usrdata['background'] ?>">
                                </div>
                            </div>
                            <div class="col-9">
                                ...
                                <div class="row mr-0 ml-0">
                                    <div class="col-3 py-2 pl-0 pr-0"><b>State</b></div>
