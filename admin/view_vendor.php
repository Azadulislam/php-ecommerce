<?php
    $title = "View Vendor || Azad demo shop";
                        ...
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body profile">
                                ...
                                <div class="col-md-8 mx-auto">
                                    <div class="row">
                                        <div class="col-6 col-md-4" ><img class="img-fluid" src="<?= $dir.$user['profile'] ?>" alt="Profile picture"></div>
                                        <div class="col-6 col-md-4" ><img class="img-fluid" src="<?= $dir.$user['background'] ?>" alt="Background image"></div>
                                    </div>
                                    <h2 class="mt-3 text-center"><?= $user['fname'] ?></h2>
                                    <h5 class="mb-3 text-center"><?= $user['lname'] ?></h5>
                                    <div class="row">
