        ...
        <div class="col-12">
            <div class="card card-outline-info">
                <div class="card-header">
                    <h4 class="m-b-0 text-white mess">Customer list <a class="btn btn-info float-right" href="addcustomer.php"><i class="fas fa-user-plus"></i></a></h4>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive m-t-10">
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <tbody >
                            <?php
                                $sel_user = $db->rnQuery("SELECT * FROM `user` WHERE `roll`='1'");
                                $i=1;
                                if(mysqli_num_rows($sel_user) > 0){
                                    while($user = mysqli_fetch_array($sel_user)){
                                        ...
                                        <tr id="data">
                                            ...
                                            <td><a href="view_customer.php?view=<?= $user['id'] ?>" class="btn btn-info mr-2"><i class="fas fa-eye"></i></a><a href="edit_customer.php?edit=<?= $user['id'] ?>" class="btn btn-info"><i class="fas fa-edit"></i></a></td>
                                        </tr>
                                        <?php
                                        $i++;
                                    }
